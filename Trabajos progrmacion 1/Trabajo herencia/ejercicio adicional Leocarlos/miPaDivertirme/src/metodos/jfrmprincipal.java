 ...
 *
 * @author leocarlos
 * le hace falta la verificacion de excepciones
 */
public class jfrmprincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Matricula", "Modelo", "Tipo de vehiculo", "Numero de puestos (carro)", "Marca (Moto)"
            }
        ));
        ...
        jMenuItem3.setText("Eliminar vehiculo (matricula)");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        String mat=JOptionPane.showInputDialog(" Digite la matricula del vehiculo a eliminar");
        jfrmpri.setDelMat(mat);
