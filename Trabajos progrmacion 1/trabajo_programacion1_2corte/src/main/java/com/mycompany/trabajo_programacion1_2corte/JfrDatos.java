...
public class JfrDatos extends javax.swing.JFrame {
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        boolean estado = false;// estado para saber si guardo o no guardo
        ...
        if (estado != false) {
            ...
            if (pos < auxD.jfrpri.v.length) {
                ...
                // elimino los que esta en los JTextField
                jtexmatricula.setText("");
                jtexmarca.setText("");
                jtexmodelo.setText("");
                jtexprecio.setText("");
                rdbestado.setSelected(false);// hago que el boton este deselecccionado.
          ...
          // actualizo la tabla
            auxD.jfrpri.setllenarJTable(auxD.JTable1);
