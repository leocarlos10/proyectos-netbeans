...
public class JfrPrincipal extends javax.swing.JFrame {
   ...
   Concesionario_V jfrpri;
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("ordenamiento (A-Z seleccion)");
        ...
        jMenuItem7.setText("buscar vehiculo (matricula)");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        Jfrtam tam = new Jfrtam(this);
        tam.setVisible(true);
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
       // busqueda binaria 
       String matri=JOptionPane.showInputDialog(" Digite la matricula del auto que desea buscar");
       // capturamos la posicion
       int pos=jfrpri.getBusqueda_Bi(matri);
       if(pos==-1)
          JOptionPane.showMessageDialog(null," los sentimos la matricula del vehiculo no ha sido encontrada");
       else
          jfrpri.v[pos].mostrar();
       
    }//GEN-LAST:event_jMenuItem7ActionPerformed

    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // busqueda secuencial.
        String marca=JOptionPane.showInputDialog(" digite la marca del carro a buscar");
        int pos = jfrpri.setBusqueda_Marca(marca);
        if(pos==-1)
            JOptionPane.showMessageDialog(null," los sentimos la marca del vehiculo no ha sido encontrada");
        else
            jfrpri.v[pos].mostrar();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        jfrpri.setOrdenamiento_seleccion();
